...
{
    /// <inheritdoc />
    public partial class InitialNorthwindCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortalUserCustomerMaps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PortalUserCustomerMaps_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderMetas", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK_OrderMetas_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartLines_CartHeaders_CartHeaderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PickedQty = table.Column<short>(type: "smallint", nullable: false),
                    PickedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PickedByUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderFulfillments_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartLines_CartHeaderId",
                table: "CartLines",
                column: "CartHeaderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderFulfillments_ProductId",
                table: "OrderFulfillments",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortalUserCustomerMaps_CustomerId",
                table: "PortalUserCustomerMaps",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_PortalUserCustomerMaps_UserId",
                table: "PortalUserCustomerMaps",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PortalUserCustomerMaps_UserId_CustomerId",
                table: "PortalUserCustomerMaps",
